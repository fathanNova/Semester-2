...
int main() {
    ...
    do{
      ...
      cout << "5. Urutkan Barang Berdasarkan Abjad\n";
      cout << "6. Urutkan Barang Berdasarkan ID\n";
...
void sortingName(){
    ...
    if(empty()){
        ...
        cout<<"\nMengurutkan Barang Berdasarkan Alphabet Abjad\n";
...
void sortingID(){
    ...
    if(empty()){
        ...
        cout<<"\nMengurutkan Barang Berdasarkan Alphabet ID\n";
        for(int i = 0; i < stack.top; i++){
