...
_0x0:
	.DB  0x50,0x6F,0x74,0x20,0x31,0x20,0x3A,0x20
	.DB  0x25,0x64,0x0,0x50,0x6F,0x74,0x20,0x32
	.DB  0x20,0x3A,0x20,0x25,0x64,0x0,0x50,0x6F
	.DB  0x74,0x20,0x33,0x20,0x3A,0x20,0x25,0x64
	.DB  0x0,0x50,0x6F,0x74,0x20,0x34,0x20,0x3A
...
; 0000 004E lcd_puts(dataADC);
	LDI  R26,LOW(_dataADC)
	LDI  R27,HIGH(_dataADC)
	CALL _lcd_puts
; 0000 004F 
...
;OPTIMIZER ADDED SUBROUTINE, CALLED 4 TIMES, CODE SIZE REDUCTION:3 WORDS
SUBOPT_0x2:
	LDI  R30,LOW(_dataADC)
	LDI  R31,HIGH(_dataADC)
	ST   -Y,R31
	ST   -Y,R30
	RET
