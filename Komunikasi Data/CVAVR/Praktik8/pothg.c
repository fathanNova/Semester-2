...
while (1)
      {    
       ...
       lcd_gotoxy(0,1);
       adc1 = (read_adc(1)* 2000L ) / 1023;
       sprintf(dataADC, "Pot 2 : %d", adc1);
       lcd_puts(dataADC); 
                           
       
       lcd_gotoxy(0,2);
       adc2 = (read_adc(2)*5000L ) / 1023;
       sprintf(dataADC, "Pot 3 : %d", adc2);
       lcd_puts(dataADC); 
                         
       
       lcd_gotoxy(0,3);
       adc3 = (read_adc(3)*25000L ) / 1023;
       sprintf(dataADC, "Pot 4 : %d", adc3);
       lcd_puts(dataADC);  
